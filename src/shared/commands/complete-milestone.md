...
4. **Archive milestone:**
   ...
   - Create `.aidlc/milestones/v{{version}}-ROADMAP.md`
...
5. **Archive requirements:**
   ...
   - Create `.aidlc/milestones/v{{version}}-REQUIREMENTS.md`
   - Mark all v1 requirements as complete (checkboxes checked)
   - Note requirement outcomes (validated, adjusted, dropped)
   - Delete `.aidlc/REQUIREMENTS.md` (fresh one created for next milestone)
...
- Milestone archived to `.aidlc/milestones/v{{version}}-ROADMAP.md`
- Requirements archived to `.aidlc/milestones/v{{version}}-REQUIREMENTS.md`
- `.aidlc/REQUIREMENTS.md` deleted (fresh for next milestone)

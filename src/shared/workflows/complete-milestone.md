...
1. Extracts full milestone details to `.aidlc/milestones/v[X.Y]-ROADMAP.md`
2. Archives requirements to `.aidlc/milestones/v[X.Y]-REQUIREMENTS.md`
...
ls .aidlc/phases/*/SUMMARY.md 2>/dev/null | wc -l
```
...
```bash
cat .aidlc/phases/01-*/01-*-SUMMARY.md
cat .aidlc/phases/02-*/02-*-SUMMARY.md
...
Create or update `.aidlc/MILESTONES.md`.
...
Update `.aidlc/ROADMAP.md` to group completed milestone phases.
...
6. Write filled template to `.aidlc/milestones/v[X.Y]-ROADMAP.md`
...
8. Verify archive exists:
   ```bash
   ls .aidlc/milestones/v[X.Y]-ROADMAP.md
   ```
...
**Note:** Phase directories (`.aidlc/phases/`) are NOT deleted. They accumulate across milestones as the raw execution history. Phase numbering continues (v1.0 phases 1-4, v1.1 phases 5-8, etc.).
...
1. Read current REQUIREMENTS.md:
   ```bash
   cat .aidlc/REQUIREMENTS.md
   ```

2. Create archive file: `.aidlc/milestones/v[X.Y]-REQUIREMENTS.md`
...
4. Write archive file with header:
   ...
   **Status:** ✅ SHIPPED
   ...
   For current requirements, see `.aidlc/REQUIREMENTS.md` (created for next milestone).
...
[ -f .aidlc/v[X.Y]-MILESTONE-AUDIT.md ] && mv .aidlc/v[X.Y]-MILESTONE-AUDIT.md .aidlc/milestones/
```
...
See: .aidlc/PROJECT.md (updated [today])
...
See .aidlc/MILESTONES.md for full details.
EOF
)"
```
...
git add .aidlc/milestones/v[X.Y]-ROADMAP.md
git add .aidlc/milestones/v[X.Y]-REQUIREMENTS.md
git add .aidlc/milestones/v[X.Y]-MILESTONE-AUDIT.md 2>/dev/null || true

# Stage updated files
git add .aidlc/MILESTONES.md
git add .aidlc/PROJECT.md

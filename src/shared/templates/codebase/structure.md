...
Template for `.aidlc/codebase/STRUCTURE.md` - captures physical file organization.
...
│   └── sdlc/           # AI-SDLC-specific commands
├── ai-sdlc/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/sdlc/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `ai-sdlc/templates/{name}.md`

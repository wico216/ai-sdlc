...
Template for `.aidlc/codebase/ARCHITECTURE.md` - captures conceptual code organization.
...
**State Management:**
- File-based: All state lives in `.aidlc/` directory
...
- Triggers: User runs `sdlc <command>`

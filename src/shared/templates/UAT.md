...
- This section feeds directly into /sdlc:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /sdlc:plan-phase --gaps with root causes
...
**Creation:** When /sdlc:verify-work starts new session

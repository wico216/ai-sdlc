...
Template for `.aidlc/construction/unit-NNN/user-setup.md` - human-required configuration that Claude cannot automate.
...
**Trigger:** `user_setup` exists in bolt-plan.md frontmatter and has items.

**Location:** Same directory as bolt-plan.md and bolt-summary.md.

**Timing:** Generated after bolt execution, before bolt-summary.md creation.

---

## Frontmatter Schema

In bolt-plan.md, `user_setup` declares human-required configuration:
...
<stripe_example>
```markdown
# Unit 010: User Setup Required

**Generated:** 2025-01-14
**Unit:** unit-010-monetization
**Status:** Incomplete
...
<supabase_example>
```markdown
# Unit 002: User Setup Required

**Generated:** 2025-01-14
**Unit:** unit-002-authentication
**Status:** Incomplete
...
<sendgrid_example>
```markdown
# Unit 005: User Setup Required

**Generated:** 2025-01-14
**Unit:** unit-005-notifications
**Status:** Incomplete
...
**Naming:** `user-setup.md` lives in the unit directory (e.g., `.aidlc/construction/unit-010/user-setup.md`).
**Status tracking:** User marks checkboxes and updates status line when complete.
**Searchability:** `grep -r "user-setup" .aidlc/` finds all units with user requirements.

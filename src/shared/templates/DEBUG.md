...
Template for `.aidlc/debug/[slug].md` — active debug session tracking.
...
**Creation:** Immediately when __CMD_PREFIX__debug is called
...
**On resolution:**
- status → "resolved"
- Move file to .aidlc/debug/resolved/

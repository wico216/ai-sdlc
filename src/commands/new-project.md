...
**Creates:**
- `.aidlc/PROJECT.md` — project context
- `.aidlc/config.json` — workflow preferences
- `.aidlc/research/` — domain research (optional)
- `.aidlc/REQUIREMENTS.md` — scoped requirements
...
Synthesize all context into `.aidlc/PROJECT.md` using the template from `templates/project.md`.
...
1. Read `.aidlc/codebase/ARCHITECTURE.md` and `STACK.md`
...
- `.aidlc/PROJECT.md`
- `.aidlc/config.json`
- `.aidlc/research/` (if research selected)
  - `STACK.md`
  - `FEATURES.md`
  - `ARCHITECTURE.md`
  - `PITFALLS.md`
...
- [ ] sdlc-roadmapper spawned with context

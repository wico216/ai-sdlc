...
**Creates/Updates:**
- `.aidlc/PROJECT.md` — updated with new milestone goals
- `.aidlc/research/` — domain research (optional, focuses on NEW features)
- `.aidlc/REQUIREMENTS.md` — scoped requirements for this milestone
...
```bash
git add .aidlc/PROJECT.md .aidlc/STATE.md
...
Spawn 4 parallel sdlc-project-researcher agents with milestone-aware context:
...
<research_files>
Read these files:
- .aidlc/research/STACK.md
- .aidlc/research/FEATURES.md
- .aidlc/research/ARCHITECTURE.md
- .aidlc/research/PITFALLS.md
</research_files>
...
Create `.aidlc/REQUIREMENTS.md` with:
...
Spawn sdlc-roadmapper agent with context:
...
", subagent_type="sdlc-roadmapper", model="{roadmapper_model}", description="Create roadmap")
```
...
- Re-spawn roadmapper with revision context:
  ...
  Current ROADMAP.md: @.aidlc/ROADMAP.md

  Update the roadmap based on feedback. Edit files in place.
  Return ROADMAP REVISED with changes made.
  </revision>
  ", subagent_type="sdlc-roadmapper", model="{roadmapper_model}", description="Revise roadmap")
  ```
- Present revised roadmap
- Loop until user approves

**If "Review full file":** Display raw `cat .aidlc/ROADMAP.md`, then re-ask.
...
If committing:
```bash
git add .aidlc/ROADMAP.md .aidlc/STATE.md .aidlc/REQUIREMENTS.md
git commit -m "$(cat <<'EOF'
...
| Research       | `.aidlc/research/`       |
| Requirements   | `.aidlc/REQUIREMENTS.md` |
| Roadmap        | `.aidlc/ROADMAP.md`      |
...
- [ ] sdlc-roadmapper spawned with phase numbering context

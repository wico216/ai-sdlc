...
<execution_context>
<!-- Spawns sdlc-planner agent which has all planning expertise baked in -->
</execution_context>

<context>
**Audit results:**
Glob: .aidlc/v*-MILESTONE-AUDIT.md (use most recent)
...
ls -t .aidlc/v*-MILESTONE-AUDIT.md 2>/dev/null | head -1
```
...
```bash
ls -d .aidlc/phases/*/ | sort -V | tail -1
```

...
```bash
grep -A20 "Phase ${PHASE}:" .aidlc/ROADMAP.md
cat .aidlc/REQUIREMENTS.md 2>/dev/null
cat .aidlc/phases/${PHASE}-*/*-CONTEXT.md 2>/dev/null
grep -A30 "### Decisions Made" .aidlc/STATE.md 2>/dev/null
```

Present summary with phase description, requirements, prior decisions.

## 4. Spawn sdlc-phase-researcher Agent
...
<output>
Write to: .aidlc/phases/${PHASE}-{slug}/${PHASE}-RESEARCH.md
</output>
```
...
<prior_state>
Research file: @.aidlc/phases/${PHASE}-{slug}/${PHASE}-RESEARCH.md
</prior_state>
...
- [ ] sdlc-phase-researcher spawned with context

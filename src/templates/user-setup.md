...
Template for `.aidlc/phases/XX-name/{phase}-USER-SETUP.md` - human-required configuration that Claude cannot automate.
...
**Searchability:** `grep -r "USER-SETUP" .aidlc/` finds all phases with user requirements.

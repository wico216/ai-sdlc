...
> **Note:** Planning methodology is in `agents/sdlc-planner.md`.
> This template defines the PLAN.md output format that the agent produces.

Template for `.aidlc/phases/XX-name/{phase}-{plan}-PLAN.md` - executable phase plans optimized for parallel execution.
...
```markdown
<context>
@.aidlc/phases/03-features/03-01-SUMMARY.md  # Just because it's earlier
@.aidlc/phases/03-features/03-02-SUMMARY.md  # Reflexive chaining
</context>
```
...
<output>
After completion, create `.aidlc/phases/03-features/03-01-SUMMARY.md`
</output>
```
...
@.aidlc/PROJECT.md
@.aidlc/ROADMAP.md
@.aidlc/phases/03-features/03-01-SUMMARY.md
@.aidlc/phases/03-features/03-02-SUMMARY.md
</context>
...
<output>
After completion, create `.aidlc/phases/03-features/03-03-SUMMARY.md`
</output>
```

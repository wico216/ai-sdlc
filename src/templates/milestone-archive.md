...
This template is used by the complete-milestone workflow to create archive files in `.aidlc/milestones/`.
...
_For current project status, see .aidlc/ROADMAP.md_
...
- Save to `.aidlc/milestones/v{VERSION}-{NAME}.md`
- Example: `.aidlc/milestones/v1.0-mvp.md`

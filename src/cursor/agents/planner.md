---
name: planner
description: Use for creating execution plans, task breakdowns, and bolt planning. Invoked during /sdlc-plan-phase.
model: inherit
readonly: false
is_background: false
---
...
Follow the planning protocol in `~/.claude/agents/sdlc-planner.md`.

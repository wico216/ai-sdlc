...
**Output:** `.aidlc/phases/XX-name/DISCOVERY.md`
</step>
...
**Output:** `.aidlc/phases/XX-name/DISCOVERY.md` (comprehensive)
</step>
...
Write `.aidlc/phases/XX-name/DISCOVERY.md`:
- Summary with recommendation
...
```
Discovery complete: .aidlc/phases/XX-name/DISCOVERY.md
